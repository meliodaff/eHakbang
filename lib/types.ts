 ...
 * the PRD's original structured response schema (§9.1.2); requirements are
 * now generated by the eGov AI Assistant (see
 * `lib/server/egov-ai-journey.ts`) and cached in Supabase. App-level
...
/** UI + eGov AI prompt language preference. */
 ...
 * eGov AI journey schema; the rest is app state.
 */
